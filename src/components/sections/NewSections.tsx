...
export const FeatureDeepDive = () => {
    ...
    useEffect(() => {
        ...
        const resumeCtx = gsap.context(() => {
            ...
            tl.set(".doc-line", { backgroundColor: "#e2e8f0" }); 
        ...
        const writingCtx = gsap.context(() => {
             ...
             // 3. Typing sequence
             const lines = gsap.utils.toArray(".type-line");
...
export const FAQ = () => {
    ...
    useEffect(() => {
        faqs.forEach((_, i) => {
            ...
            if (openIndex === i) {
                gsap.to(el, { height: "auto", duration: 0.6, ease: "expo.out" });
                gsap.to(el.querySelector('.answer-inner'), { y: 0, opacity: 1, duration: 0.6, delay: 0.1, ease: "power2.out" });
            } else {
                gsap.to(el, { height: 0, duration: 0.5, ease: "power3.inOut" });
                gsap.to(el.querySelector('.answer-inner'), { y: -10, opacity: 0, duration: 0.3 });
            }
        });
    }, [openIndex]);
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    <div className="lg:col-span-1">
                        <div className="lg:sticky lg:top-32">
                            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight leading-none mb-6">COMMON <br/> QUERIES</h2>
                            <p className="text-slate-500 text-lg leading-relaxed">Everything you need to know about the platform, billing, and our technology.</p>
                            <div className="mt-8">
                            ...
                            <div key={i} className="faq-item border-b border-slate-200 group">
                                ...
                                >
                                    <div className="answer-inner pl-12 pr-6 pb-8 opacity-0 translate-y-[-10px]">
                                        <p className="text-lg text-slate-500 leading-relaxed max-w-2xl">{item.a}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
